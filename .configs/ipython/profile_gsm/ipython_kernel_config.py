...
import os
#c.ConnectionFileMixin.connection_file = os.environ['HOME'] + '/.config/ipython/profile_gsm/kernel-gsm.json'
c.ConnectionFileMixin.connection_file = 'kernel-gsm.json'
